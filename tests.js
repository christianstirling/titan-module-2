...
/*  Test set 6 - Handle type: (9)Regular Screwdriver
*/
...
input = [
    {
        name: "Task 6a",
        handleType: "Regular Screwdriver",
        modifiers: ["Clockwise", "Palm-down (60 degrees Pronated) ? Hand-shake (Neutral) ? Palm-up (60 degrees Supinated)"],
        forceCount: 1,
        forceMagnitude: 1,
        forceDuration: 1,
        hand: "Left"
...

    {
        name: "Task 6a",
        handleType: "Regular Screwdriver",
        modifiers: ["Counter-clockwise", "Palm-down (60 degrees Pronated) ? Hand-shake (Neutral) ? Palm-up (60 degrees Supinated)"],
        forceCount: 1,
        forceMagnitude: 1,
        forceDuration: 1,
        hand: "Left"
